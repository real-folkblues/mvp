// export const button =
//   "hover:bg-slate-500 dark:hover:bg-slate-600 text-slate-900 dark:text-white border border-slate-900 dark:border-white py-2 px-4 rounded focus:outline-4 cursor-pointer";
